...
5. Square orthogonal matrices $Q$ have orthonormal columns $Q^T = Q^{-1}$. For square matrices $Q^TQ = I$ leads to $QQ^T = I$. The columns of $Q$ are an orthonormal basis for $\R^n$. The rows of $Q$ are an orthonormal basis for $R^n$. 
